...
| [`spec/approvals.yaml`](../spec/approvals.yaml)                                                                            | written by people, never by an agent | Which components a person has approved, per platform, and at what fingerprint               | [engineering/architecture.md](engineering/architecture.md#approvals)        |
...
| Pick up unfinished work                                        | [engineering/open-work.md](engineering/open-work.md), `npm run solar:triage` for what each component needs, and `npm run solar:status` for what can be worked on         |
