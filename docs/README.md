...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Human-written Foundations reference (18 chapters + agent quick-reference)                                                                                                                                                            | Every component but Button. Button proves the component pipeline end to end (milestone 3a); the other six planned components and visual parity against Figma are milestone 3b.                                |
...
| **Code generation**: `npm run solar:codegen` emits tokens to CSS, MUI, Tailwind and Flutter, the icons and logos to React, raw SVG and Flutter, and Button's recipe to MUI and Flutter, with parity suites proving the targets agree |
| **Components**: SOLAR Button for React (`@bwp-web/components`, on MUI) and for Flutter (`SolarButtonRecipe.style` on `FilledButton`), each overridable through a reviewed overlay in `spec/overlay/`                                 |                                                                                                                                                                                                               |
...
across MUI and Flutter, against the spec as the oracle. The 29 places code and Figma differ are
