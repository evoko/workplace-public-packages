...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Human-written Foundations reference (18 chapters + agent quick-reference)                                                                                                                                                                                                                                                                        | Every component but Button, Icon Button, Button Group and Spinner. The rest of milestone 3b-2 (Checkbox, StatusIndicator, Tag, Text Input, Tabs, Card, Sparkline, the Stepper parts, Dialog) is waves C to F of its plan.                           |
...
| **Code generation**: `npm run solar:codegen` emits tokens to CSS, MUI, Tailwind and Flutter, the icons and logos to React, raw SVG and Flutter, and the Button, Icon Button, Button Group and Spinner recipes to MUI and Flutter, with parity suites proving the targets agree                                                                   |
| **Components**: SOLAR Button, Icon Button, Button Group and Spinner for React (`@bwp-web/components`, on MUI) and for Flutter (`SolarButton`, `SolarIconButton`, `SolarButtonGroup`, `SolarSpinner`), each overridable through a reviewed overlay in `spec/overlay/`, and checked on both platforms against what Figma draws, variant by variant |                                                                                                                                                                                                                                                     |
