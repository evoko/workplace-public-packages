...
| **Code generation**: `npm run solar:codegen` emits tokens to CSS, MUI, Tailwind and Flutter, the icons and logos to React, raw SVG and Flutter, and the Button, Icon Button, Button Group, Spinner and StatusIndicator recipes to MUI and Flutter, with parity suites proving the targets agree                                                                                           |
| **Components**: SOLAR Button, Icon Button, Button Group, Spinner and StatusIndicator for React (`@bwp-web/components`, on MUI) and for Flutter (`SolarButton`, `SolarIconButton`, `SolarButtonGroup`, `SolarSpinner`, `SolarStatusIndicator`), each overridable through a reviewed overlay in `spec/overlay/`, and checked on both platforms against what Figma draws, variant by variant |                                                                                                                                                                                                                                                                               |
