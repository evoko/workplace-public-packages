...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Human-written Foundations reference (18 chapters + agent quick-reference)                                                                                                                                                                                                                                                                        | Every component but Button, Icon Button, Button Group and Spinner. The other 128 in SOLAR Web's components section are milestone 4, [family by family](superpowers/plans/2026-09-24-solar-library-families.md); `npm run solar:triage` says what each needs. |
