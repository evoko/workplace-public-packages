...
| **Section Nav Item** · [8109:19](https://figma.com/design/OGvmMNnywH7JWDyEhOzjcc?node-id=8109-19) | The **resting item hugs its words**, where every other state is 220px wide. We draw every state spanning its rail.                                                                            | 1        |
...
| **Insight Row** · [6905:61](https://figma.com/design/OGvmMNnywH7JWDyEhOzjcc?node-id=6905-61)              | **The row is fixed at 64** while its words, at their own line heights, need 76 (their boxes are drawn shorter than their lines). We let it hug its words. Its severity is a colour bar alone: we name it by its word for a screen reader; SOLAR may want an icon (WCAG 1.4.1). | 10       |
