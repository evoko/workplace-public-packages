...
// Provenance of the raw extraction. Generated files record the SOURCE's fetch date and file
// version, never the build date, so rebuilding unchanged inputs produces no diff.
