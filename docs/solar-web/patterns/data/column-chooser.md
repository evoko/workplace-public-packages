...
- **state=default** · component · column gap 0 pad 0/0/0/0 FIXED/FIXED · 320×720  
  ...
  - **Button** · instance of **Button** (size=lg, prio=primary, state=default, danger=false) · row gap 12 pad 0/20/0/20 FILL/FIXED · 320×48  
    fill `color.action.primary.bg.default` · stroke `color.action.primary.border.default` 0px · itemSpacing `inset.sm` · padding `inset.lg` · strokeWeight `border.none` · radius `radius.none`
...
Top-level layers of the first variant: Header · content · Button. Instances keep their SOLAR component names.
