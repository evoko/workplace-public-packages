...
> SOLAR Web · Figma page `↳ 🟢 404 Not Found` (id `5066:16`) · section `views/system` · raw data: [`raw/views/system/404-not-found.json`](../../raw/views/system/404-not-found.json)

## Component set: 404 Not Found
...
- **breakpoint=desktop** · component · column gap 0 pad 24/0/24/0 FIXED/FIXED · 1440×800  
  ...
  - **Center Stack** · frame · column gap 20 pad 0/0/0/0 HUG/HUG · 256×241  
    itemSpacing `stack.lg`
    - **icons8-broken-link 1** · frame · FIXED/FIXED · 96×96
      - **Vector** · vector · 79×79  
        fill `color.icon.inverse`
    - **Error 404** · text `title/sm` "Error 404" · HUG/HUG · 87×15  
    ...
    - **The page you're looking for doesn't exist or may have been moved.** · text `body/md/regular` "The page you're looking for doesn't exist or may have been moved." · HUG/HUG · 256×30  
