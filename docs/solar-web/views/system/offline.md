...
> SOLAR Web · Figma page `↳ 🟢 Offline` (id `5066:19`) · section `views/system` · raw data: [`raw/views/system/offline.json`](../../raw/views/system/offline.json)

## Component set: Offline
...
- **breakpoint=desktop** · component · column gap 0 pad 24/0/24/0 FIXED/FIXED · 1440×800  
  ...
  - **Center Stack** · frame · column gap 20 pad 0/0/0/0 HUG/HUG · 199×245  
    itemSpacing `stack.lg`
    - **icons8-cloud-cross (1) 1** · frame · FIXED/FIXED · 96×96
      - **Vector** · vector · 96×60  
        fill `color.icon.inverse`
    - **You're offline** · text `title/sm` "You're offline" · HUG/HUG · 118×15  
    ...
    - **Check your internet connection and try again.** · text `body/md/regular` "Check your internet connection and try again." · HUG/HUG · 199×30  
