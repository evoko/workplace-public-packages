...
> SOLAR Web · Figma page `↳ 🟢 403 Forbidden` (id `5066:17`) · section `views/system` · raw data: [`raw/views/system/403-forbidden.json`](../../raw/views/system/403-forbidden.json)

## Component set: 403 Forbidden
...
- **breakpoint=desktop** · component · column gap 0 pad 24/0/24/0 FIXED/FIXED · 1440×800  
  ...
  - **Center Stack** · frame · column gap 20 pad 0/0/0/0 HUG/HUG · 166×245  
    itemSpacing `stack.lg`
    - **icons8-lockdown 1** · frame · FIXED/FIXED · 96×96
      - **Vector** · vector · 79×79  
        fill `color.icon.inverse`
    - **Error 403** · text `title/sm` "Error 403" · HUG/HUG · 87×15  
    ...
    - **You don't have permission to access this page.** · text `body/md/regular` "You don't have permission to access this page." · HUG/HUG · 166×30  
    ...
    - **Button** · instance of **Button** (size=md, prio=tertiary, state=default, danger=false) · row gap 8 pad 0/12/0/12 HUG/FIXED · 80×44  
