...
> SOLAR Web · Figma page `↳ 🟢 Members` (id `5066:9`) · section `views/org-admin` · raw data: [`raw/views/org-admin/members.json`](../../raw/views/org-admin/members.json)
...
Instance census (tree capped at depth 3): Column Item ×102, Icon/None ×22, Icon/ChevronDown ×20, Tag ×17, Row ×17, RowSelect ×17, Checkbox ×17, RowExpand ×17, Avatar ×16, Icon/More ×16, Counter ×10, Section Nav Item ×8, Tab Item ×8, PaginationItem ×4, Tree Group Header ×3, Breadcrumb Item ×3, Icon/ChevronRight ×3, Select ×3, Button ×2, Spinner ×2, Icon Button ×2, PaginationNav ×2, Icon/Users ×1, Icon/Shield ×1, Icon/Licenses ×1, Icon/File ×1, Icon/PanKnob ×1, Icon/Key ×1, Icon/Ethernet ×1, Icon/History ×1, Page Header ×1, Breadcrumbs ×1, Icon/Building ×1, StatusIndicator ×1, Icon/Download ×1, Icon/Invite ×1, Tabs ×1, SearchField ×1, Icon/Search ×1, Icon/Filter ×1, Table ×1, Dropdown ×1, Pagination ×1, Icon/ChevronLeft ×1, PaginationEllipsis ×1
...
| ---------- | -------- | -------------------- | ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| desktop    | 1368×744 |                      |        |        | `color.text.tertiary`<br>`color.text.primary`<br>`color.text.secondary`<br>`color.text.feedback.success`<br>`color.action.secondary.text.default`<br>`color.action.primary.text.default`<br>`color.neutral.700`<br>`color.text.feedback.info` | `color.icon.primary`<br>`color.icon.secondary`<br>`color.action.secondary.icon.default`<br>`color.action.primary.icon.default`  |
| mobile     | 377×744  | `color.surface.base` |        |        | `color.text.secondary`<br>`color.text.primary`<br>`color.text.feedback.success`<br>`color.action.primary.text.default`<br>`color.text.tertiary`<br>`color.neutral.700`<br>`color.text.feedback.info`                                          | `color.icon.secondary`<br>`color.icon.primary`<br>`color.action.tertiary.icon.default`<br>`color.action.secondary.icon.default` |
...
The org member directory — invite, view and manage people and their roles. Admin-only; users edit their own profile in User Profile.

**Layout**

Page header + Invite · Data Table (name · email · role · status) · Filter Panel / search · row actions (edit role · remove).

**Responsive**

Desktop: full table. Mobile: member cards / condensed rows.

**States**

loaded, loading, empty (invite prompt), no-results (filter), error; row states (pending invite, disabled).

**Accessibility**

Table with headers; row + bulk actions labelled and announced. Role change and remove confirmed. Keyboard-complete; visible focus.

**Rules**

Show role + status per member  
Confirm remove  
Support search + filter  
Handle pending invites

Let an admin remove themselves silently  
Hide status  
Bulk-act without confirm  
Expose others' private data
