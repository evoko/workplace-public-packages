...
| Icon color   | `color.action.primary.icon.default`, `color.action.secondary.icon.default`, `color.action.tertiary.icon.default`, `color.icon.disabled`, `color.icon.primary`, `color.icon.secondary`, `color.icon.tertiary`                      |
