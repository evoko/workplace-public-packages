...
| Spacing      | `inset.lg`, `inset.md`, `inset.none`, `inset.sm`, `inset.xs`, `stack.lg`, `stack.md`                                                                                                                                                                                     |
...
- Hard-coded paddingTop `24px` on layer _Content_
