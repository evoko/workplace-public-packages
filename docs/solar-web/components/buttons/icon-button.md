...
| `state` | variant | **default** · hover · active · pressed · disabled · focus · loading |
...
| sm   | square | primary   | active   | 32×32 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| sm   | round  | primary   | active   | 32×32 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| md   | square | primary   | active   | 40×40 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| md   | round  | primary   | active   | 40×40 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| lg   | square | primary   | active   | 48×48 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| lg   | round  | primary   | active   | 48×48 | `color.action.primary.bg.active`    |                         |                        |      | `color.action.primary.icon.hover`      |
...
| sm   | square | secondary | active   | 32×32 | `color.surface.active`              | `color.border.medium`   |                        |      | `color.action.secondary.icon.hover`    |
...
| sm   | round  | secondary | active   | 32×32 | `color.surface.active`              | `color.border.medium`   |                        |      | `color.action.secondary.icon.hover`    |
...
| md   | square | secondary | active   | 40×40 | `color.surface.active`              | `color.border.medium`   |                        |      | `color.action.secondary.icon.hover`    |
...
| md   | round  | secondary | active   | 40×40 | `color.surface.active`              | `color.border.medium`   |                        |      | `color.action.secondary.icon.hover`    |
...
| lg   | square | secondary | active   | 48×48 | `color.surface.active`              |                         |                        |      | `color.action.secondary.icon.hover`    |
...
| lg   | round  | secondary | active   | 48×48 | `color.surface.active`              |                         |                        |      | `color.action.secondary.icon.hover`    |
...
| sm   | square | tertiary  | active   | 32×32 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
...
| sm   | round  | tertiary  | active   | 32×32 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
...
| md   | square | tertiary  | active   | 40×40 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
...
| md   | round  | tertiary  | active   | 40×40 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
...
| lg   | square | tertiary  | active   | 48×48 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
...
| lg   | round  | tertiary  | active   | 48×48 | `color.surface.active`              |                         |                        |      | `color.action.tertiary.icon.hover`     |
