...
| filled   | 400×107 |      |        |        | `color.text.primary`<br>`color.text.feedback.info`<br>`color.text.tertiary`                                                                                        | `color.icon.primary`<br>`color.action.secondary.icon.default`<br>`color.action.secondary.icon.danger.default` |
| focus    | 400×107 |      |        |        | `color.text.primary`<br>`color.text.feedback.info`<br>`color.text.tertiary`<br>`color.action.secondary.text.default`<br>`color.action.primary.text.default`        | `color.icon.tertiary`<br>`color.action.secondary.icon.default`                                                |
