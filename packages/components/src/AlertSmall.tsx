// Generated by @bwp-web/codegen from packages/codegen/src/components/alert-small.mjs. Do not edit.
/**
 * SOLAR Alert Small.
 *
 * Generated from its template in `packages/codegen/src/components/` on every `npm run
 * solar:codegen`: change the template there, never this file. What it looks like is not here. That
 * is the recipe, `solarAlertSmallStyle` and `solarAlertSmallCompose` in `@bwp-web/styles/mui`: each
 * type's fill, edge and words, filled or outlined, and the StatusIndicator it shows.
 *
