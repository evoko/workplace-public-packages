 ...
 * `solarTreeItemTree` and `solarTreeItemSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarTreeItemStyle` and `solarTreeItemCompose` in `@bwp-web/styles/mui`: the
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarTreeItemTree,
          slots: solarTreeItemSlots,
          parts,
          text: { label },
          icons: {
