 ...
 * SOLAR EmptyState.
 *
 * Scaffolded once by `npm run solar:scaffold EmptyState` from spec/components/emptystate.json, and
 * owned by developers from then on: change it freely. What it looks like is not here. That is the
 * recipe, `solarEmptyStateStyle` and `solarEmptyStateCompose` in `@bwp-web/styles/mui`: the stack’s
 * spacing, the icon’s size and colour, and the words’ text styles.
 *
