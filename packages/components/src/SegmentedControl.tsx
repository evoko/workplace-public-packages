 ...
 * `solarSegmentedControlTree` and `solarSegmentedControlSlots` beside the recipe. What it looks
 * like is not here. That is the recipe, `solarSegmentedControlStyle` and
...
import {
  ...
  solarSegmentedControlSlots,
  solarSegmentedControlTree,
  ...
  return (
    ...
    >
      {drawChildren('root', {
        ...
        tree: solarSegmentedControlTree,
        slots: solarSegmentedControlSlots,
        parts: drawn,
        text: {
