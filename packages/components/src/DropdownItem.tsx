 ...
 * `solarDropdownItemTree` and `solarDropdownItemSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarDropdownItemStyle` and `solarDropdownItemCompose` in
 * `@bwp-web/styles/mui`: the row's fill by state, and its words' and icon's ink.
 *
...
import {
  ...
  solarDropdownItemSlots,
  solarDropdownItemTree,
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarDropdownItemTree,
          slots: solarDropdownItemSlots,
          parts,
