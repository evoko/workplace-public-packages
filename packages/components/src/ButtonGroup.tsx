 ...
 * `solarButtonGroupStyle` in `@bwp-web/styles/mui`: the direction, the gap, the padding, the
 * full-width bar's divider, and its buttons filling it. This file is behaviour.
 *
...
export type ButtonGroupLayout =
  | { orientation?: 'horizontal'; type?: SolarButtonGroupType }
  ...
  function ButtonGroup(inProps, ref) {
    ...
    return (
      <Box
        ...
        {...rest}
        sx={[
          solarButtonGroupStyle({ orientation, type }),
