 ...
 * is the recipe, `solarLaunchCardStyle` and `solarLaunchCardCompose` in `@bwp-web/styles/mui`: the
 * card’s fill, edge, radius and focus ring, its image’s frame, and its words’ ink.
 *
