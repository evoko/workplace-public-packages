 ...
 * `solarAccordionTree` and `solarAccordionSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarAccordionStyle` and `solarAccordionCompose` in `@bwp-web/styles/mui`:
 * the header's rule, fill and focus ring by state, and the content's, collapsed and expanded.
 *
...
export const Accordion = forwardRef<HTMLElement, AccordionProps>(
  function Accordion(inProps, ref) {
    ...
    const heading = drawChildren('root', {
      ...
      tree: solarAccordionTree,
      slots: solarAccordionSlots,
