 ...
 * `solarDatePickerTree` and `solarDatePickerSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarDatePickerStyle` and `solarDatePickerCompose` in
 * `@bwp-web/styles/mui`: the field's fill, edge and focus ring by state, its words' and icon's ink,
...
export const DatePicker = forwardRef<HTMLDivElement, DatePickerProps>(
  function DatePicker(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarDatePickerTree,
      slots: solarDatePickerSlots,
