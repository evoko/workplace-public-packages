 ...
 * `solarCardTree` and `solarCardSlots` beside the recipe. What it looks like is not here. That is
 * the recipe, `solarCardStyle` and `solarCardCompose` in `@bwp-web/styles/mui`: the surface’s fill,
 * edge, shadow and focus ring by status and state, its words’ and icons’ ink, the Tag it shows, and
 * the placeholders.
 *
