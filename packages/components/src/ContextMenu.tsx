 ...
 * `solarContextMenuTree` and `solarContextMenuSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarContextMenuStyle` and `solarContextMenuCompose` in
...
import {
  ...
  solarContextMenuSlots,
  solarContextMenuTree,
      ...
      >
        ...
        >
          {drawChildren('root', {
            ...
            tree: solarContextMenuTree,
            slots: solarContextMenuSlots,
            parts,
