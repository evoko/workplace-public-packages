 ...
 * `solarInsightCardSmallTree` and `solarInsightCardSmallSlots` beside the recipe. What it looks
 * like is not here. That is the recipe, `solarInsightCardSmallStyle` and
 * `solarInsightCardSmallCompose` in `@bwp-web/styles/mui`: the surface’s edge, shadow and focus
 * ring by state, the severity’s tile, its words, the StatusIndicator it shows, and the
 * placeholders.
 *
...
import {
  ...
  solarInsightCardSmallSlots,
  solarInsightCardSmallTree,
    ...
    <>
      ...
      >
        ...
        {drawChildren('root', {
          ...
          tree: solarInsightCardSmallTree,
          slots: solarInsightCardSmallSlots,
          parts,
