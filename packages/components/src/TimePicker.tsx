 ...
 * `solarTimePickerTree` and `solarTimePickerSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarTimePickerStyle` and `solarTimePickerCompose` in
...
export const TimePicker = forwardRef<HTMLDivElement, TimePickerProps>(
  function TimePicker(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarTimePickerTree,
      slots: solarTimePickerSlots,
