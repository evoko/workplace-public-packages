 ...
 * `solarTimePickerDropdownTree` and `solarTimePickerDropdownSlots` beside the recipe. What it looks
 * like is not here. That is the recipe, `solarTimePickerDropdownStyle` and
 * `solarTimePickerDropdownCompose` in `@bwp-web/styles/mui`: the surface’s fill, edge, corners and
 * shadow.
 *
...
import {
  ...
  solarTimePickerDropdownSlots,
  solarTimePickerDropdownTree,
      ...
      >
        ...
        >
          {drawChildren('root', {
            ...
            tree: solarTimePickerDropdownTree,
            slots: solarTimePickerDropdownSlots,
            parts,
