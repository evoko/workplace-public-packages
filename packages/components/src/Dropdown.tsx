 ...
 * `solarDropdownTree` and `solarDropdownSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarDropdownStyle` and `solarDropdownCompose` in `@bwp-web/styles/mui`: the
...
export const Dropdown = forwardRef<HTMLDivElement, DropdownProps>(
  function Dropdown(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarDropdownTree,
      slots: solarDropdownSlots,
