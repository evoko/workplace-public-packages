 ...
 * `solarPasswordInputTree` and `solarPasswordInputSlots` beside the recipe. What it looks like is
 * not here. That is the recipe, `solarPasswordInputStyle` and `solarPasswordInputCompose` in
...
import {
  ...
  solarPasswordInputSlots,
  solarPasswordInputTree,
...
export const PasswordInput = forwardRef<HTMLDivElement, PasswordInputProps>(
  function PasswordInput(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarPasswordInputTree,
      slots: solarPasswordInputSlots,
