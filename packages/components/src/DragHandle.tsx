 ...
 * is the recipe, `solarDragHandleStyle` and `solarDragHandleCompose` in `@bwp-web/styles/mui`: the
 * dots’ size and colour by state, and the grip’s padding and focus ring.
 *
