 ...
 * SOLAR Trend Badge.
 *
 * Scaffolded once by `npm run solar:scaffold Trend Badge` from spec/components/trend-badge.json,
 * and owned by developers from then on: change it freely. What it looks like is not here. That is
 * the recipe, `solarTrendBadgeStyle` and `solarTrendBadgeCompose` in `@bwp-web/styles/mui`: each
