 ...
 * `solarTextAreaTree` and `solarTextAreaSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarTextAreaStyle` and `solarTextAreaCompose` in `@bwp-web/styles/mui`: the
...
export const TextArea = forwardRef<HTMLDivElement, TextAreaProps>(
  function TextArea(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarTextAreaTree,
      slots: solarTextAreaSlots,
