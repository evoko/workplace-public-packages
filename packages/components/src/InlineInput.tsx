 ...
 * `solarInlineInputTree` and `solarInlineInputSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarInlineInputStyle` and `solarInlineInputCompose` in
 * `@bwp-web/styles/mui`: its box by mode and state, and its words' ink.
 *
...
import {
  ...
  solarInlineInputSlots,
  solarInlineInputTree,
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarInlineInputTree,
          slots: solarInlineInputSlots,
