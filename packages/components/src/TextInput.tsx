 ...
 * `solarTextInputTree` and `solarTextInputSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarTextInputStyle` and `solarTextInputCompose` in `@bwp-web/styles/mui`:
...
export const TextInput = forwardRef<HTMLDivElement, TextInputProps>(
  function TextInput(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarTextInputTree,
      slots: solarTextInputSlots,
