 ...
 * is the recipe, `solarDeviceCardStyle` and `solarDeviceCardCompose` in `@bwp-web/styles/mui`: the
 * card’s fill, edge and focus ring, each type’s layout, its words’ and icons’ ink, and the
 * placeholders.
 *
