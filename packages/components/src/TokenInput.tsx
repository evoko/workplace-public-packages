 ...
 * `solarTokenInputTree` and `solarTokenInputSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarTokenInputStyle` and `solarTokenInputCompose` in
 * `@bwp-web/styles/mui`: the field's fill, edge and focus ring by state, the draft's ink, and the
 * label and helper.
 *
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarTokenInputTree,
          slots: solarTokenInputSlots,
