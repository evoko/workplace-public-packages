 ...
 * `solarSectionNavItemTree` and `solarSectionNavItemSlots` beside the recipe. What it looks like is
 * not here. That is the recipe, `solarSectionNavItemStyle` and `solarSectionNavItemCompose` in
...
import {
  ...
  solarSectionNavItemSlots,
  solarSectionNavItemTree,
  ...
  return (
    ...
    >
      {drawChildren('root', {
        ...
        tree: solarSectionNavItemTree,
        slots: solarSectionNavItemSlots,
        parts,
        text: { label },
