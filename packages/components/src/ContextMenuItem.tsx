 ...
 * `solarContextMenuItemTree` and `solarContextMenuItemSlots` beside the recipe. What it looks like
 * is not here. That is the recipe, `solarContextMenuItemStyle` and `solarContextMenuItemCompose` in
...
import {
  ...
  solarContextMenuItemSlots,
  solarContextMenuItemTree,
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarContextMenuItemTree,
          slots: solarContextMenuItemSlots,
          parts,
