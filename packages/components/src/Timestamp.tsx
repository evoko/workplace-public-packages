 ...
 * SOLAR Timestamp.
 *
 * Scaffolded once by `npm run solar:scaffold Timestamp` from spec/components/timestamp.json, and
 * owned by developers from then on: change it freely. What it looks like is not here. That is the
 * recipe, `solarTimestampStyle` and `solarTimestampCompose` in `@bwp-web/styles/mui`: its text
 * style and colour, by size and emphasis.
 *
