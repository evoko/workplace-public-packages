 ...
 * is the recipe, `solarLaunchCardFullScreenStyle` and `solarLaunchCardFullScreenCompose` in
 * `@bwp-web/styles/mui`: the page’s fill, radius and padding, its image’s frame, and its words’
 * ink.
 *
