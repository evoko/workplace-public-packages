 ...
 * SOLAR Alert.
 *
 * Scaffolded once by `npm run solar:scaffold "Alert"` from spec/components/alert.json,
 * and owned by developers from then on: change it freely. What it looks like is not here. That is
 * the recipe, `solarAlertStyle` and `solarAlertCompose` in `@bwp-web/styles/mui`: each type's
