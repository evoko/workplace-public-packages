 ...
 * `solarInsightRowTree` and `solarInsightRowSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarInsightRowStyle` and `solarInsightRowCompose` in
 * `@bwp-web/styles/mui`: the surface’s edge, shadow and focus ring by state, the severity’s bar,
 * its words, and the placeholders.
 *
      ...
      <>
        ...
        >
          ...
          {drawChildren('root', {
            ...
            tree: solarInsightRowTree,
            slots: solarInsightRowSlots,
            parts,
