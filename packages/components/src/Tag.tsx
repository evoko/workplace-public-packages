 ...
 * `solarTagTree` and `solarTagSlots` beside the recipe. What it looks like is not here. That is the
 * recipe, `solarTagStyle` and `solarTagCompose` in `@bwp-web/styles/mui`: each status's fill, edge
 * and words, inverted or not, and each type's layout.
 *
