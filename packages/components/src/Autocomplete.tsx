 ...
 * `solarAutocompleteTree` and `solarAutocompleteSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarAutocompleteStyle` and `solarAutocompleteCompose` in
 * `@bwp-web/styles/mui`: the field's fill, edge and focus ring by state, its words' and icons' ink,
 * and the label and helper; open, Autocomplete Open's gap between the field and its suggestions.
 *
...
import {
  ...
  solarAutocompleteSlots,
  solarAutocompleteTree,
...
export const Autocomplete = forwardRef(function Autocomplete<T>(
  ...
  const drawing: LayerDrawing = {
    ...
    tree: solarAutocompleteTree,
    slots: solarAutocompleteSlots,
