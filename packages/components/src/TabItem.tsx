 ...
 * `solarTabItemTree` and `solarTabItemSlots` beside the recipe. What it looks like is not here.
 * That is the recipe, `solarTabItemStyle` and `solarTabItemCompose` in `@bwp-web/styles/mui`: the
    ...
    return (
      <Tab
        ...
        label={drawChildren('root', {
          prefix: 'SolarTabItem',
          tree: solarTabItemTree,
          slots: solarTabItemSlots,
          parts,
          text: { label },
          icons: {
