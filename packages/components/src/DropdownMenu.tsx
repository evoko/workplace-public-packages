 ...
 * `solarDropdownMenuTree` and `solarDropdownMenuSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarDropdownMenuStyle` and `solarDropdownMenuCompose` in
...
import {
  ...
  solarDropdownMenuSlots,
  solarDropdownMenuTree,
        ...
        >
          ...
          >
            {drawChildren('root', {
              ...
              tree: solarDropdownMenuTree,
              slots: solarDropdownMenuSlots,
              parts,
