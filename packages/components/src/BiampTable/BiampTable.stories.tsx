...
const columns = [
  columnHelper.accessor('name', {
    ...
    // table can never hide every column.
    enableHiding: false,
    meta: { minWidth: 200 },
  }),
...
const serverSideColumns = [
  serverSideColumnHelper.accessor('name', {
    ...
    // because this story uses `useBiampServerSideTable` — also forces it visible
    // regardless of persisted state, so the table can never hide every column.
    enableHiding: false,
