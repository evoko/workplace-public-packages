 ...
 * `solarFileUploadTree` and `solarFileUploadSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarFileUploadStyle` and `solarFileUploadCompose` in
 * `@bwp-web/styles/mui`: the drop zone's fill, edge and focus ring by state, its file's ink, and
 * the label and helper.
 *
    ...
    return (
      ...
      >
        ...
        {drawChildren('root', {
          ...
          tree: solarFileUploadTree,
          slots: solarFileUploadSlots,
