 ...
 * `solarStatusCardTree` and `solarStatusCardSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarStatusCardStyle` and `solarStatusCardCompose` in
 * `@bwp-web/styles/mui`: the surface’s edge, shadow and focus ring by state, its words’ ink, the
 * StatusIndicator it shows, and the placeholders.
 *
      ...
      <>
        ...
        >
          ...
          {drawChildren('root', {
            ...
            tree: solarStatusCardTree,
            slots: solarStatusCardSlots,
            parts,
