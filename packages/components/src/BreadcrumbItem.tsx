 ...
 * `solarBreadcrumbItemTree` and `solarBreadcrumbItemSlots` beside the recipe. What it looks like is
 * not here. That is the recipe, `solarBreadcrumbItemStyle` and `solarBreadcrumbItemCompose` in
...
import {
  ...
  solarBreadcrumbItemSlots,
  solarBreadcrumbItemTree,
    ...
    return (
      ...
      >
        {drawChildren('root', {
          ...
          tree: solarBreadcrumbItemTree,
          slots: solarBreadcrumbItemSlots,
          parts,
          text: { label: children },
        })}
      </Box>
