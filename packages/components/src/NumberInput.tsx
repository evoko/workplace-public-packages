 ...
 * `solarNumberInputTree` and `solarNumberInputSlots` beside the recipe. What it looks like is not
 * here. That is the recipe, `solarNumberInputStyle` and `solarNumberInputCompose` in
 * `@bwp-web/styles/mui`: the field's fill, edge and focus ring by state, its number's and steppers'
 * ink, and the label and helper, by stepper.
 *
...
import {
  ...
  solarNumberInputSlots,
  solarNumberInputTree,
...
export const NumberInput = forwardRef<HTMLDivElement, NumberInputProps>(
  function NumberInput(inProps, ref) {
    ...
    const drawing: LayerDrawing = {
      ...
      tree: solarNumberInputTree,
      slots: solarNumberInputSlots,
