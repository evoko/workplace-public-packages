 ...
 * `solarSegmentedControlItemTree` and `solarSegmentedControlItemSlots` beside the recipe. What it
 * looks like is not here. That is the recipe, `solarSegmentedControlItemStyle` in
...
import {
  ...
  solarSegmentedControlItemSlots,
  solarSegmentedControlItemTree,
  ...
  return (
    ...
    >
      ...
      {drawChildren('root', {
        ...
        tree: solarSegmentedControlItemTree,
        slots: solarSegmentedControlItemSlots,
        parts: drawn,
        text: { label: children },
        icons: {
