...
export { default as OpenSansSemiBoldItalic } from './open-sans-semibold-italic.woff2';
export { default as OpenSansBold } from './open-sans-bold.woff2';
export { default as OpenSansBoldItalic } from './open-sans-bold-italic.woff2';
