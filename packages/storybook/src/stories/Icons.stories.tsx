  ...
  const box = (
    <Box
      sx={{
        ...
        alignItems: onlyIcon ? 'center' : 'flex-start',
...
export const IconGroups: Story = {
  ...
  render: () => (
    <Stack spacing={6}>
      <Typography variant="h3">Icon Groups by Size</Typography>

      {/* xxxxs — 6px */}
      <Stack spacing={4}>
        <Typography variant="h6">xxxxs — 6px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay name="BadgeClockIcon" onlyIcon>
            <BadgeClockIcon variant="xxxxs" />
          </IconDisplay>
          <IconDisplay name="BadgeLiveIcon" onlyIcon>
            <BadgeLiveIcon color="error" />
          </IconDisplay>
      ...
      {/* xxxs — 8px */}
      <Stack spacing={4}>
        <Typography variant="h6">xxxs — 8px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay name="BadgeClockIcon" onlyIcon>
      ...
      {/* xxs — 12px */}
      <Stack spacing={4}>
        <Typography variant="h6">xxs — 12px</Typography>
        <Box
          sx={{
            display: 'flex',
            flexWrap: 'wrap',
      ...
      {/* xs — 16px */}
      <Stack spacing={4}>
        <Typography variant="h6">xs — 16px</Typography>
        <Box
          sx={{
            display: 'flex',
            flexWrap: 'wrap',
      ...
      {/* sm — 20px */}
      <Stack spacing={4}>
        <Typography variant="h6">sm — 20px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay onlyIcon name="AccessibleIcon">
      ...
      {/* md — 24px */}
      <Stack spacing={4}>
        <Typography variant="h6">md — 24px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay onlyIcon name="AddIcon">
            <AddIcon variant="md" />
          </IconDisplay>
      ...
      {/* lg — 32px */}
      <Stack spacing={4}>
        <Typography variant="h6">lg — 32px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 600 }}>
      ...
      {/* xl — 40px */}
      <Stack spacing={4}>
        <Typography variant="h6">xl — 40px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay onlyIcon name="ArrowDownIcon">
      ...
      {/* xxl — 56px */}
      <Stack spacing={4}>
        <Typography variant="h6">xxl — 56px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
          <IconDisplay onlyIcon name="CloudNoConnectionIcon">
      ...
      {/* xxxl — 72px */}
      <Stack spacing={4}>
        <Typography variant="h6">xxxl — 72px</Typography>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4, maxWidth: 800 }}>
