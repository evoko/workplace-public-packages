...
/**
 * The attribute that switches the tokens to Dark on any subtree (`[data-theme='dark']`). The MUI
 * theme switches on the same one (emit/mui.mjs), so a stock MUI component and a SOLAR component
 * on one page change mode together.
 */
