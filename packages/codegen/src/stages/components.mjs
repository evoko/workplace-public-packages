...
export function emit({ built }) {
  for (const { spec } of built)
    writeGenerated(
      ...
      JSON.stringify(
        {
          $description: `SOLAR ${spec.component}: public API, platform states, slots and style recipe in token names. Generated by @bwp-web/codegen from docs/solar-web. Do not edit; decisions go in spec/overlay/.`,
          ...spec,
        },
        null,
        2,
