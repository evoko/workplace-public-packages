...
export const ICON_DEVIATIONS = [
  ...
  },
  {
    ...
    raise:
      'None: SOLAR confirmed on 2026-09-25 that a flat mark is not its decision but depends on Microsoft publishing one. Flutter leaves it out until then.',
  },
  {
    token: 'logo.size',
    ...
    raise:
      'None: SOLAR decided on 2026-09-25 on no logo.* scale for now; logos keep borrowing the icon ladder.',
  },
];
