...
export const solarToggleTree: Record<string, string[]> = { root: ['thumb'] };

/** Each slot's layer, to the slot it is: its class is `SolarToggle-<slot>`, public. */
export const solarToggleSlots: Record<string, string> = {};
