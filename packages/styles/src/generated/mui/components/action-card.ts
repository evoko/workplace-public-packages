...
export const solarActionCardTree: Record<string, string[]> = {
...
/** Each slot's layer, to the slot it is: its class is `SolarActionCard-<slot>`, public. */
export const solarActionCardSlots: Record<string, string> = {
  icon: 'icon',
  content: 'content',
  cta: 'cta',
