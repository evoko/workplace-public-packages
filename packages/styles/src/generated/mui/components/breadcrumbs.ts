...
export const solarBreadcrumbsTree: Record<string, string[]> = {
  root: [
    'item1',
    'iconChevronRight',
    'item2',
...
/** Each slot's layer, to the slot it is: its class is `SolarBreadcrumbs-<slot>`, public. */
export const solarBreadcrumbsSlots: Record<string, string> = {};
