// SOLAR DatePicker recipe for Flutter. Generated by @bwp-web/codegen from spec/components/datepicker.json. Do not edit.
//
...
enum SolarDatePickerSize { md, sm }

/// The props a SOLAR DatePicker takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarDatePickerProps {
  const SolarDatePickerProps({
...
abstract final class SolarDatePickerRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'required.present|base': 'b:false',
    'required.color|base': 't:color.text.feedback.info',
    'required.typography|base': 't:typography.label.md',
    'required.typography|size|sm': 't:typography.label.sm',
    ...
    'field.borderColor|appearance|default|error-focused':
        't:color.border.feedback.danger.strong',
    'field.shadow|appearance|default|error-focused': 't:shadow.focus.default',
    'iconCalendar.present|base': 'b:true',
    'iconCalendar.component|base': 'k:Icon/Calendar',
    'iconCalendar.variant.solid|base': 'k:false',
    'iconCalendar.width|base': 't:icon.sm',
    'iconCalendar.height|base': 't:icon.sm',
    'iconCalendar.color|base': 't:color.icon.primary',
    'iconCalendar.width|size|sm': 't:icon.xs',
    'iconCalendar.height|size|sm': 't:icon.xs',
    'iconCalendar.color|appearance|default|disabled': 't:color.icon.disabled',
    'value.present|base': 'b:true',
    'value.color|base': 't:color.text.primary',
    'value.typography|base': 't:typography.body.md.regular',
    'value.typography|size|sm': 't:typography.body.sm.regular',
    ...
    'helper.color|appearance|default|error-focused':
