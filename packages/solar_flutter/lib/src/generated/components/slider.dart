// SOLAR Slider recipe for Flutter. Generated by @bwp-web/codegen from spec/components/slider.json. Do not edit.
//
...
/// The props a SOLAR Slider takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarSliderProps {
  const SolarSliderProps({
    this.disabled = false,
    this.filled = false,
    this.error = false,
  });
...
abstract final class SolarSliderRecipe {
  ...
  static bool _holds(String state, SolarSliderProps p, Set<WidgetState> s) =>
      switch (state) {
  ...
  static String? lookup(String cell, SolarSliderProps p, Set<WidgetState> s) {
    const combo = 'default';
    const size = '';
  ...
  static bool present(String layer, SolarSliderProps p, Set<WidgetState> s) =>
