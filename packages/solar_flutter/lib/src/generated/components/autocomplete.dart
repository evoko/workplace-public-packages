// SOLAR Autocomplete recipe for Flutter. Generated by @bwp-web/codegen from spec/components/autocomplete.json. Do not edit.
//
...
enum SolarAutocompleteSize { md, sm }

/// The props a SOLAR Autocomplete takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarAutocompleteProps {
  const SolarAutocompleteProps({
...
abstract final class SolarAutocompleteRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'field.paddingRight|size|sm': 't:inset.sm',
    'field.paddingLeft|size|sm': 't:inset.sm',
    ...
    'search.color|base': 't:color.text.tertiary',
