// SOLAR TimePicker recipe for Flutter. Generated by @bwp-web/codegen from spec/components/timepicker.json. Do not edit.
//
...
enum SolarTimePickerSize { md, sm }

/// The props a SOLAR TimePicker takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarTimePickerProps {
  const SolarTimePickerProps({
...
abstract final class SolarTimePickerRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'iconClock.present|base': 'b:true',
    'iconClock.component|base': 'k:Icon/Clock',
    'iconClock.variant.solid|base': 'k:false',
    'iconClock.width|base': 't:icon.sm',
    'iconClock.height|base': 't:icon.sm',
    'iconClock.color|base': 't:color.icon.primary',
    'iconClock.width|size|sm': 't:icon.xs',
    'iconClock.height|size|sm': 't:icon.xs',
    'iconClock.color|appearance|default|disabled': 't:color.icon.disabled',
