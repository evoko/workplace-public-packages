// SOLAR Scrim recipe for Flutter. Generated by @bwp-web/codegen from spec/components/scrim.json. Do not edit.
//
...
/// The props a SOLAR Scrim takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarScrimProps {
  const SolarScrimProps();
}

abstract final class SolarScrimRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'root.background|base': 't:color.surface.scrim',
  ...
  static bool _holds(String state, SolarScrimProps p, Set<WidgetState> s) =>
      switch (state) {
        _ => false,
      };
  ...
  static String? lookup(String cell, SolarScrimProps p, Set<WidgetState> s) {
    const combo = 'default';
    const size = '';
  ...
  static Color color(
    ...
    return switch (lookup(cell, p, s)) {
      ...
      't:color.surface.scrim' => c.surfaceScrim,
  ...
  static double? dimension(String cell, SolarScrimProps p, Set<WidgetState> s) {
  ...
  static bool present(String layer, SolarScrimProps p, Set<WidgetState> s) =>
