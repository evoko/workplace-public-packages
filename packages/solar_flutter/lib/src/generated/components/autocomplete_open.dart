// SOLAR Autocomplete Open recipe for Flutter. Generated by @bwp-web/codegen from spec/components/autocomplete open.json. Do not edit.
//
...
/// The props a SOLAR Autocomplete Open takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarAutocompleteOpenProps {
  const SolarAutocompleteOpenProps();
}

abstract final class SolarAutocompleteOpenRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'autocomplete.present|base': 'b:true',
    'autocomplete.component|base': 'k:Autocomplete',
    'autocomplete.variant.size|base': 'k:md',
    'autocomplete.variant.state|base': 'k:default',
    'autocomplete.width|base': 'k:FILL',
    'autocomplete.height|base': 'k:HUG',
    'dropdownMenu.present|base': 'b:true',
    'dropdownMenu.component|base': 'k:Dropdown Menu',
    'dropdownMenu.variant.size|base': 'k:md',
