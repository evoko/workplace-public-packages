// SOLAR Breadcrumb Item recipe for Flutter. Generated by @bwp-web/codegen from spec/components/breadcrumb item.json. Do not edit.
//
...
enum SolarBreadcrumbItemType { link, current }

/// The props a SOLAR Breadcrumb Item takes. Hover, pressed and focus are not here: they are
/// platform states, tracked by Flutter as [WidgetState]s.
@immutable
class SolarBreadcrumbItemProps {
  const SolarBreadcrumbItemProps({
...
abstract final class SolarBreadcrumbItemRecipe {
  ...
  static const Map<String, String> cells = {
    ...
    'root.shadow|appearance|type=link|focus': 't:shadow.focus.default',
