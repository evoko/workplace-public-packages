/// SOLAR Tag.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarTagRecipe.tree]. What
/// it looks like is not here. That is the recipe, [SolarTagRecipe]: each status’s fill, edge and
/// words, inverted or not, and each type’s layout, read cell by cell.
///
