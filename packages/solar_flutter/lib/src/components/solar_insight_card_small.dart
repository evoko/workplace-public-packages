...
/// is the recipe, [SolarInsightCardSmallRecipe]: the surface’s edge, shadow and focus ring by
/// state, the severity’s tile, its words, the StatusIndicator it shows, and the placeholders, read
/// cell by cell.
///
