/// SOLAR Toggle.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarToggleRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarToggleRecipe]: the track’s fill and
/// edge by state, and the thumb’s, where it sits on and off, read cell by cell.
///
