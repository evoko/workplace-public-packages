...
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter "Segmented Control"` from
/// spec/components/segmented-control.json, and owned by developers from then on: change it freely.
/// What it looks like is not here. That is the recipe, [SolarSegmentedControlRecipe]: the track,
/// and the label and helper's text styles, by size, read cell by cell.
///
