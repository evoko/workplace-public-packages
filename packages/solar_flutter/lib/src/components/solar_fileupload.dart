// Generated by @bwp-web/codegen from packages/codegen/src/components/fileupload.mjs. Do not edit.
/// SOLAR FileUpload.
///
/// Generated from its template in `packages/codegen/src/components/` on every `npm run
/// solar:codegen`: change the template there, never this file. What it looks like is not here. That
/// is the recipe, [SolarFileUploadRecipe]: the drop zone's fill, edge and focus ring by state, its
/// file's ink, and the label and helper, read cell by cell.
///
