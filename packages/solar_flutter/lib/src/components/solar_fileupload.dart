/// SOLAR FileUpload.
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter FileUpload` from
/// spec/components/fileupload.json, and owned by developers from then on: change it freely. What it
/// looks like is not here. That is the recipe, [SolarFileUploadRecipe]: the drop zone's fill, edge
/// and focus ring by state, its file's ink, and the label and helper, read cell by cell.
///
