...
/// [SolarDropdownItemRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarDropdownItemRecipe]: the row’s fill by state, and its words’ and icon’s ink, read cell by
/// cell.
///
...
class SolarDropdownItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget draw(Set<WidgetState> states) => SolarLayers(
      ...
      tree: SolarDropdownItemRecipe.tree,
