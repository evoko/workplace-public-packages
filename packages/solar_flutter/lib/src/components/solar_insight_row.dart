...
/// is the recipe, [SolarInsightRowRecipe]: the surface’s edge, shadow and focus ring by state, the
/// severity’s bar, its words, and the placeholders, read cell by cell.
///
