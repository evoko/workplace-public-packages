...
/// [SolarInsightCardRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarInsightCardRecipe]: the surface’s fill, edge, shadow and focus ring by state, the
/// severity’s tile and More ink, its words, the StatusIndicator it shows, and the placeholders,
/// read cell by cell.
///
  ...
  Widget _card(BuildContext context, VoidCallback? onMore) {
    ...
    Widget draw(Set<WidgetState> states) {
      ...
      SolarLayers layers(Map<String, List<Widget>> content) => SolarLayers(
        recipe: recipe,
        tree: SolarInsightCardRecipe.tree,
