...
/// [SolarEmptyStateRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarEmptyStateRecipe]: the stack’s spacing, the icon’s size and colour, and the words’ text
/// styles, read cell by cell.
///
...
class SolarEmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mark = SolarLayers(
      ...
      tree: SolarEmptyStateRecipe.tree,
