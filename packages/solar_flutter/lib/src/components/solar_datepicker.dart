...
/// [SolarDatePickerRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarDatePickerRecipe]: the field's fill, edge and focus ring by state, its words' and icon's
    ...
    Widget field([TextEditingController? text, FocusNode? focus]) => SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarDatePickerRecipe.tree,
