/// SOLAR Link.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarLinkRecipe.tree]. What
/// it looks like is not here. That is the recipe, [SolarLinkRecipe]: each size’s text style,
/// underlined on hover, its colours by state, and its icons’ sizes, read cell by cell.
///
