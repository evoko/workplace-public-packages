...
/// [SolarPasswordInputRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarPasswordInputRecipe]: the field's fill, edge and focus ring by state, its words' and eye's
    ...
    Widget field([TextEditingController? text, FocusNode? focus]) => SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarPasswordInputRecipe.tree,
