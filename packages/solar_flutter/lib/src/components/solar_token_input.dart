...
/// [SolarTokenInputRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarTokenInputRecipe]: the field's fill, edge and focus ring by state, the draft's ink, and
    ...
    return SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarTokenInputRecipe.tree,
