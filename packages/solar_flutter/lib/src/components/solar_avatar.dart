/// SOLAR Avatar.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarAvatarRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarAvatarRecipe]: each size, the
/// initials' text style, the border, and a logo's rounded square, read cell by cell.
///
