...
/// [SolarButtonRecipe], which regenerates from Figma on every `solar:codegen`. This file is
/// behaviour: the props, the slots, loading and accessibility, with the same props as the React
/// Button.
///
