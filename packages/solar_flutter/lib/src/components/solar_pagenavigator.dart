...
/// [SolarPageNavigatorRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarPageNavigatorRecipe]: the gaps between its parts, and its position's text style and ink,
/// read cell by cell.
///
...
class SolarPageNavigator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SolarLayers(
      ...
      tree: SolarPageNavigatorRecipe.tree,
