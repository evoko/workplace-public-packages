...
/// [SolarSearchFieldRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarSearchFieldRecipe]: the field's fill, edge and focus ring by state, and its query's and
/// icons' ink, read cell by cell.
///
    ...
    Widget field([TextEditingController? text, FocusNode? focus]) => SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarSearchFieldRecipe.tree,
