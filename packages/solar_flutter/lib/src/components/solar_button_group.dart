...
/// [SolarButtonGroupRecipe]: the direction, the gap, the padding, the full-width bar's divider, and
/// its buttons filling it, read cell by cell.
///
...
class SolarButtonGroup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final p = SolarButtonGroupProps(orientation: orientation, type: type);
