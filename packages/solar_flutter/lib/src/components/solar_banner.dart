/// SOLAR Banner.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarBannerRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarBannerRecipe]: each type’s fill and
/// icon, and the message’s and action’s text styles, read cell by cell.
///
