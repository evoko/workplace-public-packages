...
/// [SolarStatusCardRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarStatusCardRecipe]: the surface’s edge, shadow and focus ring by state, its words’ ink, the
/// StatusIndicator it shows, and the placeholders, read cell by cell.
///
  ...
  Widget _card(BuildContext context, VoidCallback? onMore) {
    ...
    Widget draw(Set<WidgetState> states) {
      ...
      SolarLayers layers(Map<String, List<Widget>> content) => SolarLayers(
        recipe: recipe,
        tree: SolarStatusCardRecipe.tree,
