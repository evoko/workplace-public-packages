/// SOLAR Counter.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarCounterRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarCounterRecipe]: the pill’s fill,
/// border and padding, and the count’s text style, by type and state, read cell by cell.
///
