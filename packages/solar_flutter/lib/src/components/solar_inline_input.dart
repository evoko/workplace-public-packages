...
/// [SolarInlineInputRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarInlineInputRecipe]: its box by mode and state, and its words' ink, read cell by cell.
///
    ...
    return SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarInlineInputRecipe.tree,
