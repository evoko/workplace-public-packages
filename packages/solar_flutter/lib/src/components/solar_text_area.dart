/// SOLAR Text Area.
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter "Text Area"` from
/// spec/components/text-area.json, and owned by developers from then on: change it freely. What it
/// looks like is not here. That is the recipe, [SolarTextAreaRecipe]: the field's fill, edge and
/// focus ring by state, its words' ink, the label and the footer, read cell by cell.
///
