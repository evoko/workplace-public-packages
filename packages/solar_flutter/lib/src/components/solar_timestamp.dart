/// SOLAR Timestamp.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarTimestampRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarTimestampRecipe]: its text style and
/// colour, by size and emphasis, read cell by cell.
///
...
class SolarTimestamp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mark = SolarLayers(
      ...
      tree: SolarTimestampRecipe.tree,
      keyPrefix: 'timestamp',
      text: {'value': text},
    ).layer('root');
