/// SOLAR Event Row.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarEventRowRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarEventRowRecipe]: the row’s fill and
/// focus ring by state, its words’ ink and the More icon’s, read cell by cell.
///
