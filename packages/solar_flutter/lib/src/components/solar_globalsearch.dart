...
/// [SolarGlobalSearchRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarGlobalSearchRecipe]: its fill, edge and focus ring by state, and its words’ and icon’s
...
class SolarGlobalSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget draw(Set<WidgetState> states) => SolarLayers(
      ...
      tree: SolarGlobalSearchRecipe.tree,
