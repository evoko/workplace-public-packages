/// SOLAR Checkbox.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarCheckboxRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarCheckboxRecipe]: the box’s fill and
/// edge by state, and the tick and dash, Figma’s own outlines, read cell by cell.
///
