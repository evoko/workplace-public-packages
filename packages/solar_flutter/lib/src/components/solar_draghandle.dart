...
/// [SolarDragHandleRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarDragHandleRecipe]: the dots' size and colour by state, and the grip's padding and focus
/// ring, read cell by cell.
///
...
class SolarDragHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget draw(Set<WidgetState> states) => SolarLayers(
      ...
      tree: SolarDragHandleRecipe.tree,
