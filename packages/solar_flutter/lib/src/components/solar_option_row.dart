/// SOLAR Option Row.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarOptionRowRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarOptionRowRecipe]: the row's padding
/// and gap, and its words' text styles, read cell by cell.
///
...
class _SolarOptionRowState<T> extends State<SolarOptionRow<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final drawn = SolarLayers(
      ...
      tree: SolarOptionRowRecipe.tree,
      keyPrefix: 'optionRow',
