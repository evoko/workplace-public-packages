/// SOLAR Toast.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarToastRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarToastRecipe]: each status’s fill, edge
/// and action colour, and the Tag drawn on the toast’s surface and edge, read cell by cell.
///
