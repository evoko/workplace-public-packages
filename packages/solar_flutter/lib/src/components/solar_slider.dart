/// SOLAR Slider.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarSliderRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarSliderRecipe]: the rail, the fill by
/// state, and the handle' size, edge and shadow, read cell by cell.
///
