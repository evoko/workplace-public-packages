/// SOLAR Image Card.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarImageCardRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarImageCardRecipe]: the tile's fill,
/// edge, shadow and focus ring, the image's frame, its words' ink, the Checkbox it shows, and the
/// unfilled tile's Plus, read cell by cell.
///
  ...
  Widget _tile(BuildContext context, VoidCallback? onMore) {
    ...
    Widget draw(Set<WidgetState> states) {
      ...
      return SolarLayers(
        ...
        tree: SolarImageCardRecipe.tree,
        keyPrefix: 'imageCard',
