/// SOLAR RowExpand.
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter RowExpand` from
/// spec/components/rowexpand.json, and owned by developers from then on: change it freely. What it
/// looks like is not here. That is the recipe, [SolarRowExpandRecipe]: each type’s chevron or
/// connector, their colours and places, read cell by cell.
///
