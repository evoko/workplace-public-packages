...
/// [SolarSegmentedControlItemRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarSegmentedControlItemRecipe]: the chosen segment's raised surface, the others' quieter
/// words, by size, read cell by cell.
///
...
class _SolarSegmentedControlItemState<T>
  ...
  Widget build(BuildContext context) {
    ...
    Widget draw(Set<WidgetState> states) => SolarLayers(
      ...
      tree: SolarSegmentedControlItemRecipe.tree,
