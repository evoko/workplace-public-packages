...
/// [SolarNumberInputRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarNumberInputRecipe]: the field's fill, edge and focus ring by state, its number's and
/// steppers' ink, and the label and helper, by stepper, read cell by cell.
///
    ...
    return SolarField(
      ...
      builder: (context, field) {
        ...
        return SolarLayers(
          ...
          tree: SolarNumberInputRecipe.tree,
