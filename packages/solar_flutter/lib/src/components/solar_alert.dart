/// SOLAR Alert.
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter Alert` from spec/components/alert.json,
/// and owned by developers from then on: change it freely. What it looks like is not here. That is
/// the recipe, [SolarAlertRecipe]: each type’s fill, edge and words, filled or outlined, and the
