...
/// is the recipe, [SolarCardRecipe]: the surface’s fill, edge, shadow and focus ring by status and
/// state, its words’ and icons’ ink, the Tag it shows, and the placeholders, read cell by cell.
///
