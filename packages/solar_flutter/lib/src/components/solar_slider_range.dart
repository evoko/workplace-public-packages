...
/// [SolarSliderRangeRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarSliderRangeRecipe]: the rail, the fill by state, and the handles' size, edge and shadow,
/// read cell by cell.
///
      ...
      child: SolarSliderInput(
        ...
        builder: (context, states, width, handle) {
          ...
          return SolarLayers(
            ...
            tree: SolarSliderRangeRecipe.tree,
