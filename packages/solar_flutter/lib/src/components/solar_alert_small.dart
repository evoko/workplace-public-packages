...
/// [SolarAlertSmallRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarAlertSmallRecipe]: each type’s fill, edge and words, filled or outlined, and the
...
class SolarAlertSmall extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mark = SolarLayers(
      ...
      tree: SolarAlertSmallRecipe.tree,
