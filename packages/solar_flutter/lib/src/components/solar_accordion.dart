/// SOLAR Accordion.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarAccordionRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarAccordionRecipe]: the header's rule,
/// fill and focus ring by state, and the content's, collapsed and expanded, read cell by cell.
///
...
class _SolarAccordionState extends State<SolarAccordion> {
  ...
  SolarLayers _layers(
    ...
    return SolarLayers(
      ...
      tree: SolarAccordionRecipe.tree,
      keyPrefix: keyPrefix,
