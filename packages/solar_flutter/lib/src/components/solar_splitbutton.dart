...
/// [SolarSplitButtonRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarSplitButtonRecipe]: the control's colours, border, shadow and focus ring by state, its
/// halves' padding, and the rule between them.
///
        ...
        builder: (context, controller) => ListenableBuilder(
          ...
          builder: (context, _) {
            ...
            final mark = SolarLayers(
              ...
              tree: SolarSplitButtonRecipe.tree,
