...
/// [SolarPaginationRecipe.tree]. What it looks like is not here. That is the recipe,
/// [SolarPaginationRecipe]: the gaps between its items, read cell by cell.
///
...
class SolarPagination extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget layerOf((String, Widget) d) => SolarLayers(
      recipe: recipe,
      tree: SolarPaginationRecipe.tree,
