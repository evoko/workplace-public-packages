/// SOLAR ListItem.
///
/// Written by hand, and never regenerated; its layer tree is the IR's, [SolarListItemRecipe.tree].
/// What it looks like is not here. That is the recipe, [SolarListItemRecipe]: the row’s fill and
/// focus ring by state, its padding, compact or not, and its words’ and icons’ ink, read cell by
/// cell.
///
