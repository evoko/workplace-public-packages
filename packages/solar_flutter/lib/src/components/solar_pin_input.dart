/// SOLAR PIN Input.
///
/// Scaffolded once by `npm run solar:scaffold -- --flutter "PIN Input"` from
/// spec/components/pin-input.json, and owned by developers from then on: change it freely. What it
/// looks like is not here. That is the recipe, [SolarPINInputRecipe]: each cell's fill, edge and
/// focus ring by state, its digit's and placeholder's ink, and the label, helper and error, read
/// cell by cell.
///
