...
/// is the recipe, [SolarPINInputRecipe]: each cell's fill, edge and focus ring by state, its
/// digit's and placeholder's ink, and the label, helper and error, read cell by cell.
///
